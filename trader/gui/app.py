...
class MainWindow(QMainWindow):
    ...
    def _page_settings(self) -> QWidget:
        ...
        c3.add(FormRow(LABELS["max_position_frac"], self.s_posfrac,
                       ...
                       "⚠ این عدد با «ریسک هر معامله» رقابت می‌کند و معمولاً همین برنده می‌شود. "
                       "اندازه‌ی پوزیشن کمینه‌ی دو چیز است: «این‌قدر ریسک کن» که با فاصله‌ی حد ضرر "
                       "بزرگ می‌شود، و «اسمی بیشتر از این نشو» که با قیمت. پس «ریسک هر معامله» فقط "
                       "وقتی به کار می‌افتد که:\n"
                       "        فاصله‌ی حد ضرر ÷ قیمت  ≥  ریسک هر معامله ÷ بزرگ‌ترین پوزیشن\n"
